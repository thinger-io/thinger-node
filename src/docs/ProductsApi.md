...
[**updateProductProfileResource**](ProductsApi.md#updateProductProfileResource) | **PUT** /v1/users/{user}/products/{product}/profile/{category}/{resource} | UpdateProductProfile
